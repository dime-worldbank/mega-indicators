...
df_pop = get_pop_from_census_gov('nigeria', update_version=update_version)
...
sdf.write.mode("overwrite").saveAsTable(f"{database_name}.nga_subnational_population_silver")
