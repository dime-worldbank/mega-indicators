...
df.rename(columns={'region': 'adm1_name', 'Date': 'year', 'Value': 'population'}, inplace=True)

df['country_code'] = 'MOZ'

columns_ordered = ['country_code', 'adm1_name', 'year', 'population', 'data_source']
