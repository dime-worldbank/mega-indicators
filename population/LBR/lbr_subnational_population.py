...
def read_country_subnational_population_gdl(country_name,country_code,adm1_name_map={}):
...
pop = read_country_subnational_population_gdl(country_name,country_code)
pop.sample(5)
