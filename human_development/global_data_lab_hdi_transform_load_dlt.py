...
def global_data_lab_hd_index():
    countries = spark.table(f'{INDICATOR_SCHEMA}.country').select('country_name', 'country_code')

    return (spark.table(f'{INDICATOR_SCHEMA}.global_data_lab_hd_index_silver')
