...
_ROWS = [
    ...
    {"indicator_key": "subnational_poverty_rate", "source_url": "https://data360.worldbank.org/en/dataset/WB_PIP"},
    ...
    {"indicator_key": "poverty_rate", "source_url": "https://data360.worldbank.org/en/dataset/WB_PIP"},
]
